...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'checkPair.wast';
  var wasmBinaryFile = 'checkPair.wasm';
  var asmjsCodeFile = 'checkPair.temp.asm.js';
...
var real__checkPair = asm["_checkPair"]; asm["_checkPair"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__checkPair.apply(null, arguments);
};
Module["asm"] = asm;
var _checkPair = Module["_checkPair"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_checkPair"].apply(null, arguments) };
;
