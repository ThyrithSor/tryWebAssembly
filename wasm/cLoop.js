...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'cLoop.wast';
  var wasmBinaryFile = 'cLoop.wasm';
  var asmjsCodeFile = 'cLoop.temp.asm.js';
...
var real__cLoop = asm["_cLoop"]; asm["_cLoop"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__cLoop.apply(null, arguments);
};
Module["asm"] = asm;
var _cLoop = Module["_cLoop"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_cLoop"].apply(null, arguments) };
;
